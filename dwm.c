...
#define ISVISIBLE(C)            (C->swallowed == NULL && (ISVISIBLEONTAG(C, C->mon->tagset[C->mon->seltags]) || C->issticky))
...
static int drawstatusbar(Monitor *m, int bh, int extra, char* stext);
